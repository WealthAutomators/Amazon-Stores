...
export const amazonNovaDataConfig: AmazonStoreDataConfig = {
  ...
  seriesEnd: "2026-07-20",
  defaultAggregate: {
    label: "Selected date range",
    totalOrderItems: 25299,
    unitsOrdered: 29663,
    orderedProductSales: 638003.51,
  ...
  insights: {
    ...
    paragraphs: [
      ...
      "Review Products Below Market Average in the ASIN carousel—the Aozora highlighter pens SKU shows a measurable gap versus similar listings in your category.",
    ],
  },
  asinAlerts: [
    {
      asin: "B0KRHIGH01",
      title: "Aozora Highlighter Pens Assorted Colors 8-Pack",
      imageUrl: "/products/kursat-aozora-highlighters.png",
    ...
    {
      asin: "B0KRBOWL02",
      title: "Stainless Steel Mixing Bowl Set 5-Piece",
      imageUrl: "/products/kursat-mixing-bowls.png",
    ...
    },
    {
      ...
      imageUrl: "/products/kursat-electric-kettle.png",
    ...
    {
      asin: "B0KRHOOK04",
      title: "Over-the-Door Hook Rack 6 Hooks",
      imageUrl: "/products/kursat-door-hook-rack.png",
    ...
    {
      asin: "B0KRBAG05",
      title: "Reusable Silicone Food Bags 6-Pack",
      imageUrl: "/products/kursat-silicone-food-bags.png",
    ...
    {
      asin: "B0KRMIR06",
      title: "LED Makeup Mirror Compact with Lights",
      imageUrl: "/products/kursat-led-makeup-mirror.png",
